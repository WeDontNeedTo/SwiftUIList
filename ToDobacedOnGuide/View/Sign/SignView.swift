...
//
//
// func ssignInWithEmail(email: String,password : String,completion: @escaping (Bool,String)->Void){
//
...
// }
//
// func ssignUpWithEmail(email: String,password : String,completion: @escaping (Bool,String)->Void){
//
...
//
//
//struct SignAdd_Previews: PreviewProvider {
